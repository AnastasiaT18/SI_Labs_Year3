#ifndef SHARED_DATA_LAB10_H
#define SHARED_DATA_LAB10_H
...
// ── PID parameters (configurable via commands) ────────────────────
extern volatile float g_Kp;
extern volatile float g_Ki;
extern volatile float g_Kd;

// ── PID internal state (written and read only by Task_Control) ────
extern volatile float g_pidOutput;      // last PID output value R(t)
